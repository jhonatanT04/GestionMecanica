          ...
          return (
            <div key={cliente.id} className="rounded-lg border border-gray-200 bg-white p-5">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  <p className="mb-2 text-xs font-semibold tracking-wide text-gray-500 uppercase">Vehículos</p>
                  <ul className="flex flex-col gap-1">
                    ...
                    {vehiculosCliente.length === 0 && (
                      <li className="text-sm text-gray-400">Sin vehículos registrados</li>
                    )}
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="flex flex-col gap-2">
                    {ordenesCliente.map((o) => (
                      <li key={o.id} className="flex items-center justify-between gap-2 text-sm text-gray-700">
                        <span>
                    ...
                    {ordenesCliente.length === 0 && (
                      <li className="text-sm text-gray-400">Sin órdenes registradas</li>
                    )}
                  </ul>
                </div>
              </div>
